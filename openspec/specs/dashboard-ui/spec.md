...
Defines the UI layer for the rider dashboard, including theme, typography, MVI state/intent/effect types, ViewModel, screen composables, and all components. Covers the full stack from Compose theme through ViewModel to individual panel components.
